...
- `is_demo` (Boolean) When set to `true`, the data source produces demo (test) data in Funnel instead of connecting to the external platform. Defaults to `false`. Changing this forces a new resource to be created.
